  ...
  methods: {
    back(e) {
      ...
      if (page.length === 1) {
        ...
        if (['pages/addEval/addEval', 'pages/illnessDetail/illnessDetail', 'pages/recipeDetail/recipeDetail', 'pages/cases/detail/index', 'pages/from/fromList/index', 'pages/follow/schedule/index', 'pages/follow/detail/index'].includes(currentPage.route)) {
